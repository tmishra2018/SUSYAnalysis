...
int Fitfractioneg_check(int ih,int metlow, int methigh, int leplow, int lephigh, int isocut){
	setTDRStyle();
	...
	TString filepath = "/uscms/homes/t/tmishra/work/CMSSW_10_2_22/src/SUSYAnalysis/test/Background_menglei/";
	...
	filename.str("");
	filename << filepath << "controlTree_egamma_qcd_" << "met" << metlow << "_" << methigh << "_pt" << leplow << "_" << lephigh << ".root";
