...
int Fitfractionmg_check(int ih,int metlow, int methigh, int leplow, int lephigh, int isocut){
	...
	filename.str("");
	filename << filepath << "controlTree_mg_qcd_" << "met" << metlow << "_" << methigh << "_pt" << leplow << "_" << lephigh <<  ".root";
