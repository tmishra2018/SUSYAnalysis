...
void analysis_T6WG(){//main  
  ...
  gSystem->Load("../../lib/libAnaClasses.so");
	...
	datachain->Add(Form("/eos/uscms/store/user/tmishra/eg_mg_treesData/resTree_mgsignal_MuonEG_%d_NEW.root",RunYear));
	...
	TFile *outputfile_t5wg = TFile::Open(Form("/uscms/home/tmishra/nobackup/signal_trees/signalTree_T5WG_%d.root",RunYear),"RECREATE");
	outputfile_t5wg->cd();
	...
	TH1D *p_t5wg_PhoEt_signal_eg = new TH1D("p_t5wg_PhoEt_signal_1700_1000_eg","",nSigEtBins, sigEtBins);
  	...
  	mgtree_t5wg->Add(Form("/uscms/home/tmishra/nobackup/signal_trees/resTree_T5WG_%d.root",RunYear));
    ...
    double s_trg_error = objectESF.getFastMuonEGTRGESFError(phoEt_t5wg_mg, lepPt_t5wg_mg)*objectESF.getFastMuonESF(lepPt_t5wg_mg,lepEta_t5wg_mg)*objectESF.getPhotonESF(phoEt_t5wg_mg, phoEta_t5wg_mg);
  	...
  	egtree_t5wg->Add(Form("/uscms/home/tmishra/nobackup/signal_trees/resTree_T5WG_%d.root",RunYear));
