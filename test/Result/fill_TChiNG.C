...
void fill_TChiNG(){//main  
  ...
  datachain->Draw("nVertex >> p_PU_data");
	...
	float Mass2 = 0.5;
	init_histo("M1M2","test_TChiNG_C1C1.root",2, 48,287.5,1487.5,1,0,1); 

	std::ostringstream histname;
	//**************   T5WG  ***************************//
	TFile *file = TFile::Open("/uscms_data/d3/mengleis/FullStatusOct/resTree_TChiNG.root");
