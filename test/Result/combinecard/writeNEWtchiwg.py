...
outdir = '/uscmst1b_scratch/lpc1/3DayLifetime/mengleis/TChiWG/'

susy_in = ROOT.TFile('../test_TChiWG.root','read')
n_channels = 36
        ...
        for l in lines:
            if (re.search('NSC', l)
                ...
                for k in range(1, n_channels+1):
                    ...
                    n_nom = h_rates['ALL_chan' + str(k) + '_rate_nom'].GetBinContent(i, j)*br_gz 
                    con_nom = h_rates['ALL_chan' + str(k) + '_rate_control'].GetBinContent(i, j) 
