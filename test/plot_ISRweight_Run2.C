// g++ `root-config --cflags` ../../lib/libAnaClasses.so plot_ISRweight_Run2.C -o plot_ISRweight_Run2.exe `root-config --libs`
#include<string>
#include<iostream>
#include<fstream>
#include<sstream>
...
void plot_ISRweight_Run2(int RunYear, bool preVFP){
	...
	ZGtree->SetBranchAddress("JetPt",  &ZG_JetPt);
  	...
  	for(unsigned ievt(0); ievt<ZGtree->GetEntries(); ++ievt){//loop on entries
		...
		if(ZG_dilepMass < 80 || ZG_dilepMass >100)continue;
				...
				if(ZG_JetPt < 50)reweightF = 1.13835;
                 		else if(ZG_JetPt >= 50 && ZG_JetPt < 100)reweightF  = 1.41521;
                 		else if(ZG_JetPt >= 100 && ZG_JetPt < 150)reweightF = 1.15993;
                 		else if(ZG_JetPt >= 150 && ZG_JetPt < 200)reweightF = 0.970083;
                 		else if(ZG_JetPt >= 200 && ZG_JetPt < 250)reweightF = 1.06389;
                 		else if(ZG_JetPt >= 250 && ZG_JetPt < 300)reweightF = 1.02677;
                 		else if(ZG_JetPt >= 300)reweightF = 0.909366;
                 		Normalization = 0.808146;    }
				
                else if(RunYear==2016 && preVFP==0){
				if(ZG_JetPt < 50)reweightF = 1.11264;
                 		else if(ZG_JetPt >= 50 && ZG_JetPt < 100)reweightF  = 1.39396;
                 		else if(ZG_JetPt >= 100 && ZG_JetPt < 150)reweightF = 1.0559;
                 		else if(ZG_JetPt >= 150 && ZG_JetPt < 200)reweightF = 0.99874;
                 		else if(ZG_JetPt >= 200 && ZG_JetPt < 250)reweightF = 0.925449;
                 		else if(ZG_JetPt >= 250 && ZG_JetPt < 300)reweightF = 0.782346;
                 		else if(ZG_JetPt >= 300)reweightF = 0.70625;
                 		Normalization = 0.837403;    }

		else if(RunYear==2017){
				if(ZG_JetPt < 50)reweightF = 1.1143;
                 		else if(ZG_JetPt >= 50 && ZG_JetPt < 100)reweightF  = 1.32324;
                 		else if(ZG_JetPt >= 100 && ZG_JetPt < 150)reweightF = 1.07083;
                 		else if(ZG_JetPt >= 150 && ZG_JetPt < 200)reweightF = 0.910973;
                 		else if(ZG_JetPt >= 200 && ZG_JetPt < 250)reweightF = 1.02096;
                 		else if(ZG_JetPt >= 250 && ZG_JetPt < 300)reweightF = 0.79391;
                 		else if(ZG_JetPt >= 300)reweightF = 0.948013;
                 		Normalization = 0.857907;    }

		else if(RunYear==2018){
				if(ZG_JetPt < 50)reweightF = 1.21769;
                 		else if(ZG_JetPt >= 50 && ZG_JetPt < 100)reweightF  = 1.36119;
                 		else if(ZG_JetPt >= 100 && ZG_JetPt < 150)reweightF = 0.975762;
                 		else if(ZG_JetPt >= 150 && ZG_JetPt < 200)reweightF = 0.939293;
                 		else if(ZG_JetPt >= 200 && ZG_JetPt < 250)reweightF = 0.818939;
                 		else if(ZG_JetPt >= 250 && ZG_JetPt < 300)reweightF = 0.907673;
                 		else if(ZG_JetPt >= 300)reweightF = 0.83708;
                 		Normalization = 0.838319;    }
	...
	raretree->SetBranchAddress("dilepMass", &rare_dilepMass);
  	...
  	for(unsigned ievt(0); ievt<raretree->GetEntries(); ++ievt){//loop on entries
		...
		if(rare_dilepMass < 80 || rare_dilepMass > 100)continue;
                if(RunYear==2016 && preVFP==1){
				if(rare_JetPt < 50)reweightF = 1.13835;
                 		else if(rare_JetPt >= 50 && rare_JetPt < 100)reweightF  = 1.41521;
                 		else if(rare_JetPt >= 100 && rare_JetPt < 150)reweightF = 1.15993;
                 		else if(rare_JetPt >= 150 && rare_JetPt < 200)reweightF = 0.970083;
                 		else if(rare_JetPt >= 200 && rare_JetPt < 250)reweightF = 1.06389;
                 		else if(rare_JetPt >= 250 && rare_JetPt < 300)reweightF = 1.02677;
                 		else if(rare_JetPt >= 300)reweightF = 0.909366;
                 		Normalization = 0.808146;    }
				
                else if(RunYear==2016 && preVFP==0){
				if(rare_JetPt < 50)reweightF = 1.11264;
                 		else if(rare_JetPt >= 50 && rare_JetPt < 100)reweightF  = 1.39396;
                 		else if(rare_JetPt >= 100 && rare_JetPt < 150)reweightF = 1.0559;
                 		else if(rare_JetPt >= 150 && rare_JetPt < 200)reweightF = 0.99874;
                 		else if(rare_JetPt >= 200 && rare_JetPt < 250)reweightF = 0.925449;
                 		else if(rare_JetPt >= 250 && rare_JetPt < 300)reweightF = 0.782346;
                 		else if(rare_JetPt >= 300)reweightF = 0.70625;
                 		Normalization = 0.837403;    }

		else if(RunYear==2017){
				if(rare_JetPt < 50)reweightF = 1.1143;
                 		else if(rare_JetPt >= 50 && rare_JetPt < 100)reweightF  = 1.32324;
                 		else if(rare_JetPt >= 100 && rare_JetPt < 150)reweightF = 1.07083;
                 		else if(rare_JetPt >= 150 && rare_JetPt < 200)reweightF = 0.910973;
                 		else if(rare_JetPt >= 200 && rare_JetPt < 250)reweightF = 1.02096;
                 		else if(rare_JetPt >= 250 && rare_JetPt < 300)reweightF = 0.79391;
                 		else if(rare_JetPt >= 300)reweightF = 0.948013;
                 		Normalization = 0.857907;    }

		else if(RunYear==2018){
				if(rare_JetPt < 50)reweightF = 1.21769;
                 		else if(rare_JetPt >= 50 && rare_JetPt < 100)reweightF  = 1.36119;
                 		else if(rare_JetPt >= 100 && rare_JetPt < 150)reweightF = 0.975762;
                 		else if(rare_JetPt >= 150 && rare_JetPt < 200)reweightF = 0.939293;
                 		else if(rare_JetPt >= 200 && rare_JetPt < 250)reweightF = 0.818939;
                 		else if(rare_JetPt >= 250 && rare_JetPt < 300)reweightF = 0.907673;
                 		else if(rare_JetPt >= 300)reweightF = 0.83708;
                 		Normalization = 0.838319;    }
...
int main(int argc, char** argv)
{
    ...
    plot_ISRweight_Run2(atoi(argv[1]), preVFP);
    return 0;
}
