...
for RunYear in "${RunYears[@]}"; do
	...
	echo 'preVFP' $preVFP >> SigConfig.txt
        ...
        if [ "$RunYear" -eq 2016 ]; then
            ...
            root -l -q pred_TTJets.C++ > "logs/ttjets_eg_${RunYear}${VFP_string}.log"
            root -l -q pred_TTGJets.C++ > "logs/ttgjets_eg_${RunYear}${VFP_string}.log"
            root -l -q pred_WWG.C++ > "logs/wwg_eg_${RunYear}${VFP_string}.log"
            root -l -q pred_WZG.C++ > "logs/wzg_eg_${RunYear}${VFP_string}.log"
            root -l -q pred_WW.C++ > "logs/ww_eg_${RunYear}${VFP_string}.log"
            root -l -q pred_WZ.C++ > "logs/wz_eg_${RunYear}${VFP_string}.log"
            ...
            root -l -q pred_TTJets.C++ > "logs/ttjets_eg_${RunYear}.log"
            root -l -q pred_TTGJets.C++ > "logs/ttgjets_eg_${RunYear}.log"
            root -l -q pred_WWG.C++ > "logs/wwg_eg_${RunYear}.log"
            root -l -q pred_WZG.C++ > "logs/wzg_eg_${RunYear}.log"
            root -l -q pred_WW.C++ > "logs/ww_eg_${RunYear}.log"
            root -l -q pred_WZ.C++ > "logs/wz_eg_${RunYear}.log"
	...
	echo 'preVFP' $preVFP >> SigConfig.txt
        ...
        if [ "$RunYear" -eq 2016 ]; then
            ...
            root -l -q pred_TTJets.C++ > "logs/ttjets_mg_${RunYear}${VFP_string}.log"
            root -l -q pred_TTGJets.C++ > "logs/ttgjets_mg_${RunYear}${VFP_string}.log"
            root -l -q pred_WWG.C++ > "logs/wwg_mg_${RunYear}${VFP_string}.log"
            root -l -q pred_WZG.C++ > "logs/wzg_mg_${RunYear}${VFP_string}.log"
            root -l -q pred_WW.C++ > "logs/ww_mg_${RunYear}${VFP_string}.log"
            root -l -q pred_WZ.C++ > "logs/wz_mg_${RunYear}${VFP_string}.log"
            ...
            root -l -q pred_TTJets.C++ > "logs/ttjets_mg_${RunYear}.log"
            root -l -q pred_TTGJets.C++ > "logs/ttgjets_mg_${RunYear}.log"
            root -l -q pred_WWG.C++ > "logs/wwg_mg_${RunYear}.log"
            root -l -q pred_WZG.C++ > "logs/wzg_mg_${RunYear}.log"
            root -l -q pred_WW.C++ > "logs/ww_mg_${RunYear}.log"
            root -l -q pred_WZ.C++ > "logs/wz_mg_${RunYear}.log"
