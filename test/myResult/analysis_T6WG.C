...
void analysis_T6WG(){//main  
	...
	//datachain->Add(Form("/eos/uscms/store/user/tmishra/eg_mg_treesData/resTree_mgsignal_MuonEG_%d_May.root",RunYear));
	...
	//**************   T5WG  ***************************//
  	TFile *file_t5wg = TFile::Open("/uscms/home/tmishra/nobackup/signal_trees/resTree_T5WG_2016.root");
  	//TFile *file_t5wg = TFile::Open(Form("/uscms/home/tmishra/nobackup/signal_trees/resTree_T5WG_%d.root",RunYear));
	...
	TH2D *p_T5WGselect       = new TH2D("p_T5WGselect","",27, 775.0, 2125.0, 420, 2.5, 2102.5); 
	TH2D *p_lowPU_t5wg_pass  = new TH2D("p_lowPU_t5wg_pass","", 27, 775.0, 2125.0, 420, 2.5, 2102.5);
	TH2D *p_lowPU_t5wg_all   = new TH2D("p_lowPU_t5wg_all", "", 27, 775.0, 2125.0, 420, 2.5, 2102.5);
	TH2D *p_highPU_t5wg_pass = new TH2D("p_highPU_t5wg_pass","",27, 775.0, 2125.0, 420, 2.5, 2102.5);
	TH2D *p_highPU_t5wg_all  = new TH2D("p_highPU_t5wg_all","", 27, 775.0, 2125.0, 420, 2.5, 2102.5);
	...
	for(unsigned ievt(0); ievt < tree_t5wg->GetEntries(); ievt++){
		...
		p_T5WGMASS->Fill(Mass1_t5wg, Mass2_t5wg);
		if(nVertex < 20)p_lowPU_t5wg_all->Fill(Mass1_t5wg, Mass2_t5wg, 1);
		else p_highPU_t5wg_all->Fill(Mass1_t5wg, Mass2_t5wg, 1);
	}
	...
	TH2D *t5wg_h_syserr_PU = new TH2D("t5wg_h_syserr_PU","t5wg_h_syserr_PU", 27, 775.0, 2125.0, 420, 2.5, 2102.5);
	...
	for(int i(0); i < NBIN*2; i++){
		...
		t5wg_h_chan_rate_jesDown[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_rate_jerUp";
		t5wg_h_chan_rate_jerUp[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_rate_jerDown";
		t5wg_h_chan_rate_jerDown[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_rate_xsUp";
		t5wg_h_chan_rate_xsUp[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_rate_esfUp";
		t5wg_h_chan_rate_esfUp[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
															
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_jes";
		t5wg_h_chan_syserr_jes[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_jer";
		t5wg_h_chan_syserr_jer[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_esf";
		t5wg_h_chan_syserr_esf[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_scale";
		t5wg_h_chan_syserr_scale[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_eleshape";
		t5wg_h_chan_syserr_eleshape[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_jetshape";
		t5wg_h_chan_syserr_jetshape[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_qcdshape";
		t5wg_h_chan_syserr_qcdshape[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_xs";
		t5wg_h_chan_syserr_xs[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_lumi";
		t5wg_h_chan_syserr_lumi[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
		histname.str("");
		histname << "h_chan" << i+1 << "_syserr_isr";
		t5wg_h_chan_syserr_isr[i] = new TH2D(histname.str().c_str(),histname.str().c_str(),27, 775.0, 2125.0, 420, 2.5, 2102.5);
	}
	...
	TH1D *p_t5wg_PhoEt_signal_eg = new TH1D("p_t5wg_PhoEt_signal_1700_1000_eg","",nSigEtBins, sigEtBins);
  	...
  	mgtree_t5wg->Add("/uscms/home/tmishra/nobackup/signal_trees/resTree_T5WG_2016.root");
	...
	for(unsigned ievt(0); ievt < mgtree_t5wg->GetEntries(); ievt++){
		...
		if(fabs(phoEta_t5wg_mg) > 1.4442 || fabs(lepEta_t5wg_mg) > 2.5)continue;
    		p_T5WGselect->Fill(Mass1_t5wg_mg, Mass2_t5wg_mg);
    ...
    double s_trg_error = objectESF.getFastMuonEGTRGESFError(phoEt_t5wg_mg, lepPt_t5wg_mg)*objectESF.getFastMuonESF(lepPt_t5wg_mg,lepEta_t5wg_mg)*objectESF.getPhotonESF(phoEt_t5wg_mg, phoEta_t5wg_mg);
		...
		if( fabs(Mass1_t5wg_mg - 1700) < 10 && fabs(Mass2_t5wg_mg - 1000) < 5){
			if(sigMT_t5wg_mg > lowMt){
				p_t5wg_MET_signal_mg->Fill(sigMET_t5wg_mg);
				if(sigMET_t5wg_mg > lowMET)p_t5wg_HT_signal_mg->Fill(HT_t5wg_mg);
				if(sigMET_t5wg_mg > lowMET)p_t5wg_PhoEt_signal_mg->Fill(phoEt_t5wg_mg);
			}
		}

		if(sigMET_t5wg_mg < lowMET || sigMT_t5wg_mg < lowMt)continue;

		int SigBinIndex(-1);
		SigBinIndex = Bin.findSignalBin(sigMET_t5wg_mg, HT_t5wg_mg, phoEt_t5wg_mg);
		if(SigBinIndex >=0){
			// susy events
			t5wg_h_chan_rate_nom[SigBinIndex]->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg, scalefactor);
			t5wg_h_chan_rate_xsUp[SigBinIndex]->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg, scalefactor); 
			t5wg_h_chan_rate_esfUp[SigBinIndex]->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg,scalefactorup); 

			if(nVertex_t5wg_mg < 20)p_lowPU_t5wg_pass->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg, 1);
			else p_highPU_t5wg_pass->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg, 1);
		}
		int jesupBinIndex(-1);	
		jesupBinIndex = Bin.findSignalBin(sigMETJESup_t5wg_mg, HTJESup_t5wg_mg, phoEt_t5wg_mg); 
		if(jesupBinIndex >=0){
			t5wg_h_chan_rate_jesUp[jesupBinIndex]->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg, scalefactor); 
		}
		int jesdoBinIndex(-1);
		jesdoBinIndex = Bin.findSignalBin(sigMETJESdo_t5wg_mg, HTJESdo_t5wg_mg, phoEt_t5wg_mg);
		if(jesdoBinIndex >=0){
			t5wg_h_chan_rate_jesDown[jesdoBinIndex]->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg, scalefactor);   
		}	
		int jerupBinIndex(-1);
		jerupBinIndex = Bin.findSignalBin(sigMETJERup_t5wg_mg, HT_t5wg_mg, phoEt_t5wg_mg); 
		if( jerupBinIndex >=0){
			t5wg_h_chan_rate_jerUp[jerupBinIndex]->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg, scalefactor);
		}
		int jerdoBinIndex(-1);
		jerdoBinIndex = Bin.findSignalBin(sigMETJERdo_t5wg_mg, HT_t5wg_mg, phoEt_t5wg_mg);
		if(jerdoBinIndex >= 0){
			t5wg_h_chan_rate_jerDown[jerdoBinIndex]->Fill( Mass1_t5wg_mg, Mass2_t5wg_mg, scalefactor);
		}  
	}

  	TChain *egtree_t5wg;
  	egtree_t5wg = new TChain("egTree","egTree");
  	egtree_t5wg->Add("/uscms/home/tmishra/nobackup/signal_trees/resTree_T5WG_2016.root");
	...
	float Mass1_t5wg_eg(0);
  	float Mass2_t5wg_eg(0);
	...
	egtree_t5wg->SetBranchAddress("Mass1",      &Mass1_t5wg_eg);
	egtree_t5wg->SetBranchAddress("Mass2",      &Mass2_t5wg_eg);
	...
	for(unsigned ievt(0); ievt < egtree_t5wg->GetEntries(); ievt++){
		...
		if( fabs(Mass1_t5wg_eg - 1700) < 10 && fabs(Mass2_t5wg_eg - 1000) < 5){
			if(sigMT_t5wg_eg > lowMt){
				p_t5wg_MET_signal_eg->Fill(sigMET_t5wg_eg);
				if(sigMET_t5wg_eg > lowMET)p_t5wg_HT_signal_eg->Fill(HT_t5wg_eg);
				if(sigMET_t5wg_eg > lowMET)p_t5wg_PhoEt_signal_eg->Fill(phoEt_t5wg_eg);
			}
		}

		if(sigMET_t5wg_eg < lowMET || sigMT_t5wg_eg < lowMt)continue;

		int SigBinIndex(-1);
		SigBinIndex = Bin.findSignalBin(sigMET_t5wg_eg, HT_t5wg_eg, phoEt_t5wg_eg) + NBIN;
		if(SigBinIndex >=0){
			t5wg_h_chan_rate_nom[SigBinIndex]->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg, scalefactor);
			t5wg_h_chan_rate_xsUp[SigBinIndex]->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg, scalefactor); 
			t5wg_h_chan_rate_esfUp[SigBinIndex]->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg,scalefactorup); 

			if(nVertex_t5wg_eg < 20)p_lowPU_t5wg_pass->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg, 1);
			else p_highPU_t5wg_pass->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg, 1);
		}
		int jesupBinIndex(-1);	
		jesupBinIndex = Bin.findSignalBin(sigMETJESup_t5wg_eg, HTJESup_t5wg_eg, phoEt_t5wg_eg) + NBIN;
		if(jesupBinIndex >=0){
			t5wg_h_chan_rate_jesUp[jesupBinIndex]->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg, scalefactor); 
		}
		int jesdoBinIndex(-1);
		jesdoBinIndex = Bin.findSignalBin(sigMETJESdo_t5wg_eg, HTJESdo_t5wg_eg, phoEt_t5wg_eg) + NBIN;
		if(jesdoBinIndex >=0){
			t5wg_h_chan_rate_jesDown[jesdoBinIndex]->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg, scalefactor);   
		}	
		int jerupBinIndex(-1);
		jerupBinIndex = Bin.findSignalBin(sigMETJERup_t5wg_eg, HT_t5wg_eg, phoEt_t5wg_eg) + NBIN;
		if( jerupBinIndex >=0){
			t5wg_h_chan_rate_jerUp[jerupBinIndex]->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg, scalefactor);
		}
		int jerdoBinIndex(-1);
		jerdoBinIndex = Bin.findSignalBin(sigMETJERdo_t5wg_eg, HT_t5wg_eg, phoEt_t5wg_eg) + NBIN;	
		if(jerdoBinIndex >= 0){
			t5wg_h_chan_rate_jerDown[jerdoBinIndex]->Fill( Mass1_t5wg_eg, Mass2_t5wg_eg, scalefactor);
		}  
	}
	float lumi = 1.0;
	for(int ih(0); ih < NBIN*2; ih++){
		for(int i(1); i < t5wg_h_chan_rate_nom[ih]->GetXaxis()->GetNbins() + 1; i++){
			for(int j(1); j < t5wg_h_chan_rate_nom[ih]->GetYaxis()->GetNbins() + 1; j++){
				...
				if(RunYear == 2016 and preVFP == 1)             lumi = lumi_2016preVFP_MuonEG;
                        	else if(RunYear == 2016 and preVFP == 0)        lumi = lumi_2016postVFP_MuonEG;
                        	else if(RunYear == 2017)                        lumi = lumi_2017_MuonEG;
                        	else if(RunYear == 2018)                        lumi = lumi_2018_MuonEG;
                        	else if(RunYear == 678)                         lumi = lumi_678_MuonEG;
				...
				if(p_T5WGMASS->GetBinContent(i,j) <= 0){
					...
					//cout <<noe <<"  "<<sparticleMass<<"  "<< crosssection<<"  "<<getEvtWeight(RunYear,crosssection,noe)<<" "<<35.9*crosssection/noe<<endl;
		...
		for(int i(1); i < p_T5WGMASS->GetXaxis()->GetNbins() + 1; i++){
			for(int j(1); j < p_T5WGMASS->GetYaxis()->GetNbins() + 1; j++){
				...
				if( fabs(sparticleMass - 1700 ) < 10 && fabs( p_T5WGMASS->GetYaxis()->GetBinCenter(j) - 1000) < 5){
					...
					p_t5wg_MET_signal_mg->Scale(lumi*crosssection/noe);
					p_t5wg_HT_signal_mg->Scale(lumi*crosssection/noe);
					p_t5wg_PhoEt_signal_mg->Scale(lumi*crosssection/noe);
					p_t5wg_MET_signal_eg->Scale(lumi*crosssection/noe);
					p_t5wg_HT_signal_eg->Scale(lumi*crosssection/noe);
					p_t5wg_PhoEt_signal_eg->Scale(lumi*crosssection/noe);
			}
		}
	}
	...
	//****************   TChiWG ***************************//
 /* 	TFile *file_tchiwg = TFile::Open("/uscms/home/tmishra/nobackup/signal_trees/resTree_TChiWG_2016_march.root");
	...
	TFile *outputfile_tchiwg = TFile::Open(Form("/uscms/home/tmishra/nobackup/signal_trees/signalTree_TChiWG_%d.root",RunYear),"RECREATE");
	...
	for(int i(0); i < NBIN*2; i++){
  	...
  	mgtree_tchiwg->Add("/uscms/home/tmishra/nobackup/signal_trees/resTree_TChiWG_2016_march.root");
    ...
    double s_trg_error = objectESF.getFastMuonEGTRGESFError(phoEt_tchiwg_mg, lepPt_tchiwg_mg)*objectESF.getFastMuonESF(lepPt_tchiwg_mg,lepEta_tchiwg_mg)*objectESF.getPhotonESF(phoEt_tchiwg_mg, phoEta_tchiwg_mg);
		...
		if( fabs(charginoMass_tchiwg_mg - 800 ) < 2){
			if(sigMT_tchiwg_mg > lowMt){
			  p_tchiwg_MET_signal_mg->Fill( sigMET_tchiwg_mg );
			  if(sigMET_tchiwg_mg > lowMET)p_tchiwg_HT_signal_mg->Fill( HT_tchiwg_mg );
			  if(sigMET_tchiwg_mg > lowMET)p_tchiwg_PhoEt_signal_mg->Fill( phoEt_tchiwg_mg );
      			}
		}

		if(sigMET_tchiwg_mg < lowMET || sigMT_tchiwg_mg < lowMt)continue;
  	...
  	egtree_tchiwg->Add("/uscms/home/tmishra/nobackup/signal_trees/resTree_TChiWG_2016_march.root");
	...
	for(unsigned ievt(0); ievt < egtree_tchiwg->GetEntries(); ievt++){
		...
		if(sigMET_tchiwg_eg < lowMET || sigMT_tchiwg_eg < lowMt)continue;
		...
		if( fabs(charginoMass_tchiwg_eg - 800 ) < 2){
			if(sigMT_tchiwg_eg > lowMt){
			  p_tchiwg_MET_signal_eg->Fill( sigMET_tchiwg_eg );
			  if(sigMET_tchiwg_eg > lowMET)p_tchiwg_HT_signal_eg->Fill( HT_tchiwg_eg );
			  if(sigMET_tchiwg_eg > lowMET)p_tchiwg_PhoEt_signal_eg->Fill( phoEt_tchiwg_eg );
      			}
		}
	...
	for(int ih(0); ih < NBIN*2; ih++){
		for(int i(1); i < tchiwg_h_chan_rate_nom[ih]->GetXaxis()->GetNbins() + 1; i++){
			...
			if(p_TChiWGMASS->GetBinContent(i) <= 0){
				...
				tchiwg_h_chan_rate_nom[ih]->SetBinError(i, sqrt(tchiwg_h_chan_rate_nom[ih]->GetBinContent(i))*getEvtWeight(RunYear,crosssection,noe));
				tchiwg_h_chan_rate_nom[ih]->SetBinContent(i, tchiwg_h_chan_rate_nom[ih]->GetBinContent(i)*getEvtWeight(RunYear,crosssection,noe)); 
				tchiwg_h_chan_rate_jesUp[ih]->SetBinContent(i, tchiwg_h_chan_rate_jesUp[ih]->GetBinContent(i)*getEvtWeight(RunYear,crosssection,noe)); 
				tchiwg_h_chan_rate_jesDown[ih]->SetBinContent(i, tchiwg_h_chan_rate_jesDown[ih]->GetBinContent(i)*getEvtWeight(RunYear,crosssection,noe));
				tchiwg_h_chan_rate_jerUp[ih]->SetBinContent(i, tchiwg_h_chan_rate_jerUp[ih]->GetBinContent(i)*getEvtWeight(RunYear,crosssection,noe));
				tchiwg_h_chan_rate_jerDown[ih]->SetBinContent(i, tchiwg_h_chan_rate_jerDown[ih]->GetBinContent(i)*getEvtWeight(RunYear,crosssection,noe));
				tchiwg_h_chan_rate_xsUp[ih]->SetBinContent(i, tchiwg_h_chan_rate_xsUp[ih]->GetBinContent(i)*getEvtWeight(RunYear,crosssectionUp,noe));
				tchiwg_h_chan_rate_esfUp[ih]->SetBinContent(i, tchiwg_h_chan_rate_esfUp[ih]->GetBinContent(i)*getEvtWeight(RunYear,crosssection,noe));
	...
	//"""""""""""""    T6WG  """"""""""""""""""//
  	...
  	TFile *file_t6wg = TFile::Open(Form("/uscms/home/tmishra/nobackup/signal_trees/resTree_T6WG_%d_march.root",RunYear));
	...
	TFile *outputfile_t6wg = TFile::Open(Form("/uscms/home/tmishra/nobackup/signal_trees/signalTree_T6WG_%d.root",RunYear),"RECREATE");
	outputfile_t6wg->cd();
	...
	for(int i(0); i < NBIN*2; i++){
  	...
  	mgtree_t6wg->Add(Form("/uscms/home/tmishra/nobackup/signal_trees/resTree_T6WG_%d_march.root",RunYear));
    ...
    double s_trg_error = objectESF.getFastMuonEGTRGESFError(phoEt_t6wg_mg, lepPt_t6wg_mg)*objectESF.getFastMuonESF(lepPt_t6wg_mg,lepEta_t6wg_mg)*objectESF.getPhotonESF(phoEt_t6wg_mg, phoEta_t6wg_mg);
		...
		if(sigMET_t6wg_mg < lowMET || sigMT_t6wg_mg < lowMt)continue;
  	...
  	egtree_t6wg->Add(Form("/uscms/home/tmishra/nobackup/signal_trees/resTree_T6WG_%d_march.root",RunYear));
	...
	for(unsigned ievt(0); ievt < egtree_t6wg->GetEntries(); ievt++){
		...
		if(sigMET_t6wg_eg < lowMET || sigMT_t6wg_eg < lowMt)continue;
		...
		for(int i(1); i < t6wg_h_chan_rate_nom[ih]->GetXaxis()->GetNbins() + 1; i++){
			for(int j(1); j < t6wg_h_chan_rate_nom[ih]->GetYaxis()->GetNbins() + 1; j++){
				...
				if(p_T6WGMASS->GetBinContent(i,j) <= 0){
				  ...
				  t6wg_h_chan_rate_nom[ih]->SetBinError(i,j, sqrt(t6wg_h_chan_rate_nom[ih]->GetBinContent(i))*getEvtWeight(RunYear,crosssection,noe));
					t6wg_h_chan_rate_nom[ih]->SetBinContent(i,j, t6wg_h_chan_rate_nom[ih]->GetBinContent(i,j)*getEvtWeight(RunYear,crosssection,noe)); 
					t6wg_h_chan_rate_jesUp[ih]->SetBinContent(i,j, t6wg_h_chan_rate_jesUp[ih]->GetBinContent(i,j)*getEvtWeight(RunYear,crosssection,noe)); 
					t6wg_h_chan_rate_jesDown[ih]->SetBinContent(i,j, t6wg_h_chan_rate_jesDown[ih]->GetBinContent(i,j)*getEvtWeight(RunYear,crosssection,noe));
					t6wg_h_chan_rate_jerUp[ih]->SetBinContent(i,j, t6wg_h_chan_rate_jerUp[ih]->GetBinContent(i,j)*getEvtWeight(RunYear,crosssection,noe));
					t6wg_h_chan_rate_jerDown[ih]->SetBinContent(i,j, t6wg_h_chan_rate_jerDown[ih]->GetBinContent(i,j)*getEvtWeight(RunYear,crosssection,noe));
					t6wg_h_chan_rate_xsUp[ih]->SetBinContent(i,j, t6wg_h_chan_rate_xsUp[ih]->GetBinContent(i,j)*getEvtWeight(RunYear,crosssectionUp,noe));
					t6wg_h_chan_rate_esfUp[ih]->SetBinContent(i,j, t6wg_h_chan_rate_esfUp[ih]->GetBinContent(i,j)*getEvtWeight(RunYear,crosssection,noe));
