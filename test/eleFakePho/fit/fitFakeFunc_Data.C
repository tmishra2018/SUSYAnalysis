...
void fitFakeFunc_Data(){//main 
	...
	/****************************   MC      *********************************/
	if(doDrellYan==true) {
	Pt_file.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-Bw-ker-pt-60-120.txt",RunYear));
        Pt_DYfile.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-DY-ker-pt-60-120.txt",RunYear));
        Pt_Polfile.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-DY-ker-pt-60-120.txt",RunYear));
        Eta_file.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-Bw-ker-eta-60-120.txt",RunYear));
        Eta_DYfile.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-DY-ker-eta-60-120.txt",RunYear));
        Eta_Polfile.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-DY-ker-eta-60-120.txt",RunYear));
        Vtx_file.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-Bw-ker-vtx-60-120.txt",RunYear));
        Vtx_DYfile.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-DY-ker-vtx-60-120.txt",RunYear));
        Vtx_Polfile.open(Form("/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult%d/EleFakeRate-DrellYan-DY-ker-vtx-60-120.txt",RunYear)); }
