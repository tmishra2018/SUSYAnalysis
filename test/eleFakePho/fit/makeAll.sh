...
rm configFit_Bw_cmsshape.txt
echo 'useCMSShape 1' >> configFit_Bw_cmsshape.txt
echo 'useExpo 0'     >> configFit_Bw_cmsshape.txt
echo 'useKer  0'     >> configFit_Bw_cmsshape.txt
echo 'useDY  0'      >> configFit_Bw_cmsshape.txt
echo 'SaveOutput 1'  >> configFit_Bw_cmsshape.txt
...
rm configFit_cb_poly.txt
echo 'useCMSShape 0' >> configFit_cb_poly.txt 
echo 'useExpo 0'     >> configFit_cb_poly.txt
echo 'useKer  0'     >> configFit_cb_poly.txt
echo 'useDY  0'      >> configFit_cb_poly.txt
echo 'usePoly 1'     >> configFit_cb_poly.txt
echo 'useCrystalBall 1'  >> configFit_cb_poly.txt
echo 'SaveOutput 1'  >> configFit_cb_poly.txt
