...
base_dir="/eos/uscms/store/user/tmishra/elefakepho/DrellYanResult"

for year in "${years[@]}"; do
    infile="${base_dir}${year}/result_eta_dependence_DY.txt"
    eb_outfile="${base_dir}${year}/result_eta_dependence_DY.txt"
    ee_outfile="${base_dir}${year}/result_eta_dependence_DY_EE.txt"
    ...
    echo -n "double MCetaRatesEB_${year}[] = {" > "$eb_outfile"
    ...
    echo -n "double MCetaRatesEE_${year}[] = {" > "$ee_outfile"
